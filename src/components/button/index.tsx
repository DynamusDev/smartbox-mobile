...
import { Container, Text, MenuContainer, MenuText, Comand } from './styles';
...
interface Props {
  ...
  tx?: string,
  type?: 'common' | 'iconButton' | 'menuButton' | 'comand',
  icon?: "link" | "search" | "image" | "menu" | "radio" | "key"
    ...
    <>
      {
        props.type === 'menuButton'
          ...
          >
            ...
            <Feather name={props.icon || 'home'} size={35} color={props.color || '#FFF'} />
          </MenuContainer>
          : props.type === 'comand' ?
            <Comand
              onPress={props.onPress}
            ...
            >
              {
                props.loading
                  ? <ActivityIndicator color={props.actColor || '#FFF'} />
                  : <Text
                    style={{
                      color: props.color || '#FFF'
                    }}
